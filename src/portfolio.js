...
const about = {
  ...
  description:
  "Hey there! I'm Dimitri Kwihangana, an engineer skilled in Python and JavaScript for web and mobile apps. I'm proficient in frontend and backend development, working with frameworks like React, Next.js, and React Native. Additionally, I have experience with machine learning, leveraging models to create intelligent and data-driven applications. I'm comfortable with databases like MongoDB and MySQL, ensuring scalable and efficient solutions. I thrive in collaborative teams and I'm eager to work together to create amazing projects.",
